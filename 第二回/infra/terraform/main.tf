...
# Platform RG: hosts the workshop VM
...
# Workshop RG: participants deploy resources here via Terraform in code-server
resource "azurerm_resource_group" "workshop" {
  name     = "rg-workshop-${local.prefix}"
  location = var.location
  tags     = merge(local.tags, { scope = "participant-terraform" })
}
